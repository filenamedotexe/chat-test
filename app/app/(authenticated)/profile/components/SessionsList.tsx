...
export function SessionsList() {
  ...
  return (
    <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-800">
      <div className="px-6 py-4 border-b border-gray-800">
        <h2 className="text-lg font-semibold text-white">Active Sessions</h2>
        <p className="text-sm text-gray-400">Manage your account access</p>
      </div>
      ...
      <div className="p-6">
        {sessions.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-xs mt-1">Session management will be available soon</p>
          </div>
        ) : (
              ...
              return (
                <div key={session.id} className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-white">{browser} on {os}</p>
                      <div className="text-sm text-gray-400 space-y-1">
                        ...
                        {isExpired && (
                          <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-900/50 text-red-200">
                            Expired
                          </span>
                        )}
                      </div>
        ...
        <div className="mt-6 p-4 bg-purple-900/20 border border-purple-800 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-purple-200">Current Session</p>
              <p className="text-sm text-purple-300">This is your current browser session. You cannot revoke it.</p>
            </div>
          </div>
        </div>
      </div>
